                ...
                <div className="pt-4 border-t border-gray-200">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            >
                                <option value="gemini-pro-3">Gemini 1.5 Pro (Preview)</option>
                                <option value="gemini-pro-2.5">Gemini 1.5 Pro</option>
                                <option value="gemini-flash">Gemini 2.0 Flash</option>
                                <option value="gemini-flash-lite">Gemini 2.0 Flash Lite</option>
                                <option value="gpt-4o">OpenAI GPT-4o</option>
                                <option value="claude-sonnet">Anthropic Claude Sonnet 3.5</option>
                            </select>
                        </div>
                        <div>
